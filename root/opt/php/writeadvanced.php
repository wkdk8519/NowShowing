...
if(isset($_POST['save_settings'])) {
  ...
  $adv_array['mail'] = array('from' => strip_tags($_POST['from']), 'subject' => strip_tags($_POST['subject']), 'announcement' => strip_tags($_POST['announcementSubject']), 'recipients_email' => $recipients_email, 'recipients' => $recipients, 'address' => strip_tags($_POST['smtp_address']), 'port' => strip_tags($_POST['smtp_port']), 'username' => strip_tags($_POST['email_username']), 'password' => strip_tags($_POST['email_password']));
