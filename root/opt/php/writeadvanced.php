...
if(isset($_POST['submit'])) {
  ...
  $adv_array['plex'] = array('plex_user_emails' => strip_tags($_POST['plex_user_emails']), 'libraries_to_skip' => $libraries_to_skip, 'server' => strip_tags($_POST['server']), 'api_key' => strip_tags($_POST['plex_token']));
